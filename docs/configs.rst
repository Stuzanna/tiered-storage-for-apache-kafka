...
``aws.credentials.file``
  This property is used to define a file where credentials are defind. The file might be updated during process life cycle, and the credentials will be reloaded from the file.
